...
df_python_romania_women = df_python_romania[df_python_romania[woman_col] == "Woman"]

# contorizez numărul de respondenți în fiecare categorie de vârstă
age_distribution = df_python_romania_women[age_col].value_counts().sort_index()
...
plt.title("Distribuția respondenților romani femei care programează în Python pe categorii de vârstă", fontsize=14)
