...
;Sa se genereze sirul D care sa contina toti
;octetii superiori ai word-urilor superioare 
;care au ultima cifra egala cu 7. 
...
data segment
	...
	S dd 39123431h, 12FC3434h , 6B345BFEh, 1BFEB1E2h
	lenS EQU $-S
	D db lenS dup(0)
	nr_cifre dw 0
	mesaj db 'Nu exista$'
...
; D4 31 34 39 34 34 FC 12 FE 5B 34 6B E2 B1 FE 1B 
; 	       --          --          --          --          
