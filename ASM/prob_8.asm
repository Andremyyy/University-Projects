;Sa se citeasca de la tastatura un sir de octeti S 
;si sa se afiseze pe ecran suma lor.
;Exemplu:
;S: 1, 2, 3, 4
;Suma: 10


; !!! nu calculeaza mereu bine pt sume negative
