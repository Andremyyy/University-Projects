...
;care au valoare impara si divizibila cu 7.
...
;Exemplu:
;S: 12343178h, ABCD5BABh, C5F3B1E5h 
;D: 31h, 5Bh
;rezultat: 49, 91
...
data segment
	...
	S dd 123431D4h, 12FC3434h , 12345BFEh, 12FEB1E2h
	lenS EQU $-S
	D db lenS dup(0)
	nr_cifre dw 0
	mesaj db 'Nu exista$'
...
; D4 31 34 12 34 34 FC 12 FE 5B 34 12 E2 B1 FE 12 
; 	 --          --          --          --          

	; octetii -- sunt octetii superiori ai cuvintelor inferioare
